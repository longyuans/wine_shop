...
<body>
	<div class="container2">
		<div class="header2">
			<div>
				<a href="index.jsp"><img class="logo" src="images/logo_main.png">
				</a>
			</div>
			<div>
				<ul class="tabs">
					<li class="phone current"><a href="#">用手机登陆</a>
					</li>
				</ul>
			</div>
			<div class="tlg">
		...
		<div class="content2">
			<form action="/wine_shop/user_regist" method="post" enctype="multipart/form-data">
				<ul class="reg_box">
					...
					<li><span><b>*</b>电话：</span> <input type="text" name="phone" /></li>
