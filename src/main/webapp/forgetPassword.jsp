	...
	<div class="container4">
		...
		<div class="register_box">
			...
			<div class="security">
				...
				<form action="/Book/forgetpasswordServlet" method="get">
					<ul class="list">
						...
						<li>
							...
							type="text" /> <span class="code"> <img id="J_imgVcode"
								title="点击更换验证码" src="/Book/AutoImage"
								onclick="this.src=this.src+'?'" alt="点击更换验证码" height="38"
								width="85" /> </span> <a id="J_vcodeImgBtn" class="more"
							onclick="change()">换一张</a>
							<div id="J_eUserNameCodeTipInfo" class="ltip"></div>
						</li>
						<li>
							<div class="name"></div> <input id="J_eUserNameSubmit"
							class="btn_red" type="submit" value="下一步"
							style="width: 86px; height: 30px; background: #ff2832;color: #ffffff;
							text-align: center;line-height:30px;font-size:16px;margin-left: 335px;padding-left: 1px">
						</li>
					</ul>
				</form>
			</div>
