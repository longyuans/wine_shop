	...
	<div class="container4">
		<div class="register_box">
			...
			<div class="security">
				...
				<form action="/Book/forgetpasswordServlet1" method="post">
					<ul class="list">
						...
						<li><input id="J_euserName" class="long" name="txtUser"
							value="请再次输入密码"
							onfocus="JavaScript:if(this.value=='请再次输入密码')this.value=' '"
							onblur="javascript:if(this.value==' ')this.value='请再次输入密码'"
							type="text" />
